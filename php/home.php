...
// Consulta para obter o id do usuário com base no email da sessão
...
// Consulta para obter os empreendimentos cadastrados pelo usuário
...
<head>
    ...
    <title>Empreendedores Faculdade Dom Bosco</title>
...
<body>
    ...
    <main>
        <div class="container mt-4">
            <h3 class="mt-4">Empreendimentos Cadastrados</h3>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <!-- Imagem de edição com link para a tela de edição -->
                                        <a href="editaEmpreendimento.php?id=<?php echo $rowEmpreendimento['id_empreendimento']; ?>">
                                            <img src="../html-css/img/editar.png" alt="Editar" width="24" height="24">
                                        </a>
                                        <!-- Imagem de exclusão com link para a função de exclusão -->
                                        <a href="excluiEmpreendimento.php?id=<?php echo $rowEmpreendimento['id_empreendimento']; ?>" onclick="return confirm('Tem certeza que deseja excluir este empreendimento?');">
